...
def graficochow(densidad: list): 
    ...
    ax1.plot(q, stats.f.cdf(q, 3, 94), label='CDF F Teórica', color='green')
    ax1.set_xlabel('Estadístico de Chow')
    ax1.set_ylabel('Probabilidad acumulada')
    ax1.set_title('ECDF empírica vs. CDF teórica del estadístico de Chow')
    ax1.legend()
    ...
    ax2.plot(q, stats.f.pdf(q, 3, 94), label='PDF F Teórica', color='green')
    ax2.set_xlabel('Estadístico de Chow')
    ax2.set_ylabel('Densidad')
    ax2.set_title('Densidad empírica vs. PDF teórica del estadístico de Chow')
    ax2.legend()
